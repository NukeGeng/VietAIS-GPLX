...
- In-progress exam question reads are scoped to the attempt's pinned Question Bank version, so publishing a newer bank cannot break an existing attempt while public listing/detail reads remain limited to published versions.
